...
<body>
    ...
    <div class="col-sm-6">
        <div class="card">
        <div class="card-body">
        <a href="new_home_screen.php">Home</a>
        <h2>Calculate BMI</h2>
            ...
            <div class="col-sm-6">
                <div class="card custom-card">
                    <div class="card-body">
                        <?php
                        // Assume $conn is the database connection object
                        $select_tracker_info = mysqli_query($conn, "SELECT tracker.bmi, tracker.date_of_bmi FROM tracker INNER JOIN user_info ON tracker.user_ID=user_info.userID WHERE user_info.username='$username'");
                        if (mysqli_num_rows($select_tracker_info) > 0) {
